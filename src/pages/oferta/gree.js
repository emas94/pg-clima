  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await Client.query(
        Prismic.Predicates.at("document.type", "gree")
      )
      if (response) {
    ...
    <Template>
      <div className="offer">
        <div className="container">
          <h2 className="default-header">Gree - sprawdź naszą ofertę</h2>
          ...
          <p className="text-content">
            ...
            urządzeń marki Gree na terenie Warszawy oraz okolic.
          </p>
          <a
            href="../../pdf/gree-cennik-2021.pdf"
            download
            className="download"
          >
            Pobierz całą ofertę
